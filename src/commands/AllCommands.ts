...
import { AddSummoner, ShowLeague, InhouseHelp, ReassignSummoner, Watch, Unwatch } from './inhouse/InhouseCommands';
...
export default class AllCommands implements CommandList {
  ...
  constructor() {
    ...
    this.commands.push(new Watch());
    this.commands.push(new Unwatch());
  }
};
